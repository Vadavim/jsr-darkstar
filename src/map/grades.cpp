...
{{
   //H, M, S, D, V, A, I, M, C
    ...
    {2, 0, 1, 3, 2, 3, 6, 6, 5}, //WAR
    {1, 0, 3, 2, 1, 4, 7, 3, 6}, //MNK
    {5, 3, 4, 6, 4, 5, 5, 1, 3}, //WHM
    {6, 2, 6, 3, 6, 3, 1, 5, 4}, //BLM
    {4, 4, 4, 4, 5, 5, 3, 3, 4}, //RDM
    {4, 0, 4, 1, 4, 2, 3, 7, 2}, //THF
    {3, 6, 2, 5, 1, 7, 7, 3, 3}, //PLD
    {3, 5, 1, 3, 4, 4, 2, 7, 7}, //DRK
    {2, 0, 3, 3, 3, 6, 5, 5, 1}, //BST
    {4, 0, 4, 2, 4, 6, 4, 4, 2}, //BRD
    {5, 0, 5, 3, 5, 1, 4, 3, 5}, //RNG
    {2, 0, 3, 3, 4, 4, 3, 5, 4}, //SAM
    {5, 0, 3, 2, 4, 1, 2, 7, 6}, //NIN
    {2, 0, 2, 4, 3, 2, 6, 5, 3}, //DRG
    {7, 1, 6, 5, 6, 4, 2, 2, 2}, //SMN
    {4, 4, 5, 5, 5, 5, 5, 5, 5}, //BLU
    {4, 0, 5, 2, 5, 2, 3, 5, 3}, //COR
    {4, 0, 5, 2, 4, 3, 5, 6, 3}, //PUP
    {4, 0, 4, 3, 4, 2, 6, 4, 2}, //DNC
    {5, 4, 6, 4, 5, 4, 3, 3, 3}, //SCH
    {4, 4, 4, 5, 4, 5, 2, 4, 3}, //GEO (NYI)
    {4, 5, 4, 2, 5, 2, 3, 2, 3}  //RUN (NYI)
}};
