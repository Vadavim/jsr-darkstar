...
local GearSets =  {
    ...
    {id = 104, items = {13734,13956,14083,14208,12482}, matches = 2, matchType = matchtype.any, mods = {{MOD_POISONRES, 5, 1, 0}, {MOD_CRIT_DMG_INCREASE, 10, 2, 0}}},   --  Scorpion Harness Set +1: +5 Poison res, +10 Crit Damage for 2 pieces, +1 for every extra
