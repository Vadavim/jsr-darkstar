...
function handleRegen(caster, target, spell, hp, duration, spellLevel)
    hp = math.ceil(hp * (1 + 0.01 * caster:getMod(MOD_REGEN_MULTIPLIER))); -- spell base times gear multipliers
