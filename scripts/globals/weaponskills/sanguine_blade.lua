...
function onUseWeaponSkill(player, target, wsID, tp, primary)
    ...
    local params = {};
    params.ftp100 = 1.65; params.ftp200 = 3.5; params.ftp300 = 5.5;
    params.str_wsc = 0.4; params.dex_wsc = 0.0; params.vit_wsc = 0.0; params.agi_wsc = 0.0; params.int_wsc = 0.0; params.mnd_wsc = 0.8; params.chr_wsc = 0.0;
    params.ele = ELE_DARK;
