...
local augStats = {AUGMENT_STR, AUGMENT_VIT, AUGMENT_CHR, AUGMENT_AGI, AUGMENT_DEX, AUGMENT_MND, AUGMENT_INT};
local augStatsNeg = {AUGMENT_STRNEG, AUGMENT_VITNEG, AUGMENT_CHRNEG, AUGMENT_AGINEG, AUGMENT_DEXNEG, AUGMENT_MNDNEG, AUGMENT_INT};
...
local petAugments = {
    {AUGMENT_PET_ACC,           {3, 8},     1, 20, false, 0.0},
    {AUGMENT_PET_ATK,           {2, 4},     1, 20, true, 0.04},
    {AUGMENT_PET_DEF,           {3, 5},     1, 20, true, 0.04},
    {AUGMENT_PET_DBLATK,        {1, 3},     45, 10, false, 0.00},
    {AUGMENT_PET_DBLATKCRIT,    {1, 2},     70, 5, false, 0.00},
    {AUGMENT_PET_ENMITY,        {2, 5},     1, 8, false, 0.00},
    {AUGMENT_PET_ENMITYNEG,     {2, 5},     1, 8, false, 0.00},
    {AUGMENT_PET_CRIT,          {2, 4},     1, 5, false, 0.00},
    {AUGMENT_PET_EVA,           {3, 8},     1, 8, false, 0.00},
    {AUGMENT_PET_MAGACCATK,     {1, 4},     1, 6, false, 0.00},
    {AUGMENT_PET_MDEF,          {2, 8},     1, 12, false, 0.00},
    {AUGMENT_PET_MEVA,          {4, 12},    1, 8, false, 0.00},
    {AUGMENT_PET_REGEN,         {1, 3},     20, 5, true, 0.1},
    {AUGMENT_PET_STORETP,       {3, 8},     30, 5, false, 0.00},
    {AUGMENT_PET_UDMG,          {2, 3},     50, 5, false, 0.00},
    {AUGMENT_PET_SUBTLEBLOW,    {5, 15},     1, 15, false, 0.00},
    {AUGMENT_PET_TPBONUS,       {1, 4},     50, 8, false, 0.00},
    {AUGMENT_PET_HASTE,         {1, 3},     70, 5, false, 0.00},
    {augPetStat,                {2, 8},     1, 40, true, 0.15},
};

local negativeAugments = {
    {AUGMENT_MPNEG,             {3, 10},    10, true, 0.02},
    {AUGMENT_HPNEG,             {5, 20},    10, true, 0.02},
    {AUGMENT_SLOW,              {1, 3},    5, true, 0.02},
    {augStatsNeg,               {2, 6},     25, true, 0.1},
    {AUGMENT_ALLRESNEG,         {4, 8},     8, false, 0.0},
    {AUGMENT_ACCNEG,            {3, 12},     20, false, 0.0},
    {AUGMENT_MACCNEG,           {3, 12},    5, false, 0.0},
}


local jewelryAugments = {
    {AUGMENT_MAGCRIT,           {3, 8},     55, 5, false, 0.0},
    {AUGMENT_MACC,              {1, 3},     30, 10, false, 0.0},
    {AUGMENT_MAGICBURST_DMG,    {5, 10},    15, 5, false, 0.0},
    {AUGMENT_SPELLINTERRUPT,    {10, 15},   1,  1, false, 0.0},
    {AUGMENT_SKILLCHAIN_DAM,    {5, 15},    15, 5, false, 0.0},
    {AUGMENT_BLOOD_BOON,        {2, 4},     50, 3, false, 0.0},
    {AUGMENT_BLOODPACTDELAY,    {1, 2},     70, 2, false, 0.0},
    {AUGMENT_CURESPELLTIME,     {8, 12},    50, 1, false, 0.0},
    {AUGMENT_CONSERVEMP,        {2, 4},     50, 5, false, 0.0},
    {AUGMENT_CONSERVETP,        {2, 4},     50, 5, false, 0.0},
    {AUGMENT_STORESUBTLE,       {2, 4},     65, 5, false, 0.0},
    {AUGMENT_CUREPOTENCY,       {2, 5},     35, 5, false, 0.0},
    {AUGMENT_CURERCVD,          {3, 6},     30, 8, false, 0.0},
    {AUGMENT_DBLATK,            {2, 3},     50, 3, false, 0.0},
    {AUGMENT_TRPLATTACK,        {1, 2},     60, 2, false, 0.0},
    {AUGMENT_FASTCAST,          {2, 3},     65, 5, false, 0.0},
    {AUGMENT_ZANSHIN,           {2, 5},     35, 3, false, 0.0},
    {AUGMENT_SUBTLEBLOW,        {3, 5},     1, 3, false, 0.0},
    {AUGMENT_QUADATK,           {1, 1},     75, 1, false, 0.0},
    {AUGMENT_UDMG,              {2, 3},     75, 1, false, 0.0},
    {AUGMENT_WALTZPOTENCY,      {3, 7},     35, 3, false, 0.0},
    {AUGMENT_MATK,              {1, 2},     40, 5, false, 0.0},
    {AUGMENT_MACCMATK,          {1, 3},     70, 1, false, 0.0},
    {AUGMENT_MDEF,              {3, 5},     40, 5, false, 0.0},
    {AUGMENT_MEVA,              {3, 5},     50, 5, false, 0.0},
    {AUGMENT_WSKILL_ACC,        {5, 10},    1, 3, false, 0.0},
    {AUGMENT_WSKILL_DAM,        {3, 6},     60, 3, false, 0.0},
    {AUGMENT_DBLATKCRIT,        {1, 2},     75, 1, false, 0.0},
    {AUGMENT_SHIELDMASTERY,     {10, 25},   45, 3, false, 0.0},
    {AUGMENT_RAPIDSHOT,         {2, 4},     35, 2, false, 0.0},
    {AUGMENT_SNAPSHOT,          {2, 4},     35, 2, false, 0.0},
    {AUGMENT_HASTE,             {1, 1},     65, 2, false, 0.0},
    {AUGMENT_REGEN,             {1, 3},     25, 5, true, 0.065},
    {augMagicSkills,            {1, 2},     1, 8, true, 0.05},
    {augMeleeSkills,            {1, 2},     1, 8, true, 0.05},
    {augRangeSkills,            {1, 2},     1, 8, true, 0.05},
    {augEleAcc,                 {3, 8},     1, 8, false, 0.0},
    {augEleAtt,                 {2, 4},     1, 8, false, 0.0},
}

local neckAugments = {
    {AUGMENT_ACC,               {1, 5},     40, 4, false, 0.0},
    {AUGMENT_ACCRNGACC,         {1, 5},     55, 4, false, 0.0},
    {AUGMENT_ENMITY,            {2, 4},     40, 3, false, 0.0},
    {AUGMENT_ENMITYNEG,         {2, 4},     40, 3, false, 0.0},
    {AUGMENT_CRITRATE,          {1, 2},     40, 2, false, 0.0},
    {AUGMENT_CRITDAMAGE,        {5, 10},    55, 2, false, 0.0},
    {AUGMENT_ATKRATK,           {1, 3},     1, 2, true, 0.05},
    {AUGMENT_KICKATTACKS,       {3, 6},     50, 1, false, 0.0},
    {AUGMENT_HP,                {4, 12},    1, 15, true, 0.2},
    {AUGMENT_MP,                {2, 8},     1, 15, true, 0.1},
    {AUGMENT_DEF,               {1, 3},     1, 8, true, 0.08},
    {AUGMENT_HPMP,              {2, 5},     30, 5, true, 0.08},
    {AUGMENT_EVA,               {1, 5},     1, 10, false, 0.0},
    {AUGMENT_ALLDARK,           {3, 12},     45, 4, false, 0.0},
    {AUGMENT_ALLLIGHT,          {3, 12},     45, 4, false, 0.0},
    {AUGMENT_ALLRES,            {2, 8},     60, 4, false, 0.0},
    {AUGMENT_TPBONUS,            {1, 3},    60, 4, false, 0.0},
    {AUGMENT_COUNTER,           {2, 4},     50, 3, false, 0.0},
    {augRes,                    {4, 20},    1, 20, false, 0.0},
    {augStats,                  {1, 3},     1, 25, true, 0.05},
    {augStatus,                 {2, 8},     1, 15, false, 0.0},
};
...
local function getAugmentValue(aug, itemlvl)
    local scales = aug[5];
    ...
    return {augment, math.random(min, max)};
end

function testPick()
    local pick = createWeightedTable(neckAugments, 75);
...
function doEliteAugments(player, slotType, itemid)
