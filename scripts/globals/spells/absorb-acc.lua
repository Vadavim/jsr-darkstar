...
function onSpellCast(caster,target,spell)
	...
	if(caster:hasStatusEffect(EFFECT_ACCURACY_BOOST)) then
		...
		if(resist <= 0.125) then
            ...
            caster:addStatusEffect(EFFECT_MAGIC_ACC_BOOST_II,ABSORB_SPELL_AMOUNT*resist, ABSORB_SPELL_TICK, ABSORB_SPELL_AMOUNT*ABSORB_SPELL_TICK,FLAG_DISPELABLE); -- caster gains MACC
            ...
            target:addStatusEffect(EFFECT_MAGIC_ACC_DOWN,ABSORB_SPELL_AMOUNT*resist, ABSORB_SPELL_TICK, ABSORB_SPELL_AMOUNT*ABSORB_SPELL_TICK,FLAG_ERASBLE);    -- target loses MACC
		end
	end
