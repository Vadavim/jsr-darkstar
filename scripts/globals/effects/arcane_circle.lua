...
function onEffectGain(target,effect)
   ...
   target:addMod(MOD_CURSERES, power * 3);
   target:addMod(MOD_DEATHRES, power * 3);
   target:addMod(MOD_DARKDEF, 60);
   target:addMod(MOD_DARKACC, 4 + power * 2);
   target:addMod(MOD_DARKATT, 2 + power);
end;
...
function onEffectLose(target,effect)
   ...
   target:delMod(MOD_CURSERES, power * 3);
   target:delMod(MOD_DEATHRES, power * 3);
   target:delMod(MOD_DARKDEF, 60);
   target:delMod(MOD_DARKACC, 4 + power * 2);
   target:delMod(MOD_DARKATT, 2 + power);
end;
