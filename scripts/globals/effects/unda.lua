...
runeType = EFFECT_UNDA;
enspellType = 3;
strongATT = MOD_WATERATT;
strongACC = MOD_WATERACC;
strongDEF = MOD_FIREDEF;
strongRES = MOD_FIRERES;
weakATT = MOD_THUNDERATT;
weakACC = MOD_THUNDERACC;
weakDEF = MOD_THUNDERDEF;
weakRES = MOD_THUNDERRES;
