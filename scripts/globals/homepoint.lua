...
homepoints[32]  = { 2,  1,     -99,      0,     167,   0, 244,  1000}; -- Upper Jeuno #1
homepoints[33]  = { 2,  2,      32,     -1,     -44,   0, 244,  1000}; -- Upper Jeuno #2
homepoints[34]  = { 2,  3,     -52,      1,      16,   0, 244,  1000}; -- Upper Jeuno #3
homepoints[35]  = { 2,  4,     -99,      0,    -183,   0, 245,  1000}; -- Lower Jeuno #1
homepoints[36]  = { 2,  5,      18,     -1,      54,   0, 245,  1000}; -- Lower Jeuno #2
homepoints[37]  = { 2,  6,      37,      0,       9,   0, 246,  1000}; -- Port Jeuno #1
homepoints[38]  = { 2,  7,    -155,     -1,      -4,   0, 246,  1000}; -- Port Jeuno #2
homepoints[39]  = { 2,  8,      78,    -13,     -94,   0, 250,  1500}; -- Kazham #1
homepoints[40]  = { 2,  9,     -13,    -15,      87,   0, 249,  1000}; -- Mhaura #1
homepoints[41]  = { 2, 10,     -27,      0,     -47,   0, 252,  2000}; -- Norg #1
homepoints[42]  = { 2, 11,     -29,      0,     -76,   0, 247,  2000}; -- Rabao #1
homepoints[43]  = { 2, 12,      36,    -11,      35,   0, 248,  1000}; -- Selbina #1
...
homepoints[49]  = { 2, 18,    -420,      0,     -62,  64, 263, 3000}; -- Yorcia Weald #1
homepoints[50]  = { 2, 19,     -23,      0,     174,   0, 266, 3000}; -- Marjami Ravine #1
homepoints[51]  = { 2, 20,     210, 20.299,     315, 192, 267, 3000}; -- Kamihr Drifts #1
homepoints[52]  = { 2, 21,     434,    -40,     171,   0, 142, 3000}; -- Yughott Grotto #1
homepoints[53]  = { 2, 22,     109,    -38,    -147,   0, 143, 1500}; -- Palborough Mines #1
homepoints[54]  = { 2, 23,    -132,     -3,    -303,   0, 145, 1500}; -- Giddeus #1
homepoints[55]  = { 2, 24,     243,    -24,      62,   0, 204, 2000}; -- Fei'Yin #1
homepoints[56]  = { 2, 25,    -984,     17,    -289,   0, 208, 2000}; -- Quicksand Caves #1
homepoints[57]  = { 2, 26,     -80,     46,      62,   0, 160, 3000}; -- Den of Rancor #1
homepoints[58]  = { 2, 27,    -554,    -70,      66,   0, 162, 3000}; -- Castle Zvahl Keep #1
homepoints[59]  = { 2, 28,       5,    -42,     526,   0, 130, 4000}; -- Ru'Aun Gardens #1
homepoints[60]  = { 2, 29,    -499,    -42,     167,   0, 130, 4000}; -- Ru'Aun Gardens #2
homepoints[61]  = { 2, 30,    -312,    -42,    -422,   0, 130, 4000}; -- Ru'Aun Gardens #3
homepoints[62]  = { 2, 31,     500,    -42,     158,   0, 130, 4000}; -- Ru'Aun Gardens #4
homepoints[63]  = { 2, 32,     305,    -42,    -427,   0, 130, 4000}; -- Ru'Aun Gardens #5
homepoints[64]  = { 3,  1,      -1,    -27,     107,   0,  26,  1500}; -- Tavnazian Safehold #1
homepoints[65]  = { 3,  2,     -21,      0,     -21,   0,  50,  1500}; -- Aht Urhgan Whitegate #1
homepoints[66]  = { 3,  3,     -20,      0,     -25,   0,  53,  2000}; -- Nashmau #1
...
homepoints[71]  = { 3,  8,    -365, -176.5,     -36,   0, 158, 1500}; -- Upper Delkfutt's Tower #1
homepoints[72]  = { 3,  9,     -13,     48,      61,   0, 178, 3000}; -- The Shrine of Ru'Avitau #1
homepoints[73]  = { 3, 10,       0,      0,       0,   0,  29, 2000}; -- Riverne - Site #B01 #1
homepoints[74]  = { 3, 11,     -98,    -10,    -493, 192,  52, 3000}; -- Bhaflau Thickets #1
homepoints[75]  = { 3, 12,    -449,     13,    -497,   0,  79, 3000}; -- Caedarva Mire #1
homepoints[76]  = { 3, 13,      64,   -196,     181,   0,   5, 3000}; -- Uleguerand Range #1
homepoints[77]  = { 3, 14,     380,     23,     -62,   0,   5, 3000}; -- Uleguerand Range #2
homepoints[78]  = { 3, 15,     424,    -32,     221,   0,   5, 3000}; -- Uleguerand Range #3
homepoints[79]  = { 3, 16,      64,    -96,     461,   0,   5, 3000}; -- Uleguerand Range #4
homepoints[80]  = { 3, 17,    -220,     -1,     -62,   0,   5, 3000}; -- Uleguerand Range #5
homepoints[81]  = { 3, 18,    -200,    -10,     342,   0,   7, 3000}; -- Attohwa Chasm #1
homepoints[82]  = { 3, 19,     -58,     40,      14,  64,   9, 3000}; -- Pso'Xja #1
homepoints[83]  = { 3, 20,     445,     27,     -22,   0,  12, 2000}; -- Newton Movalpolos #1
homepoints[84]  = { 3, 21,     189,      0,     362,   0,  30, 3000}; -- Riveren - Site #A01 #1  // Location not verified from retail
homepoints[85]  = { 3, 22,       7,      0,     709, 192,  33, 3000}; -- Al'Taieu #1
homepoints[86]  = { 3, 23,    -532,      0,     447, 128,  33, 3000}; -- Al'Taieu #2
homepoints[87]  = { 3, 24,     569,      0,     410, 192,  33, 3000}; -- Al'Taieu #3
homepoints[88]  = { 3, 25,     -12,      0,    -288, 192,  34, 3000}; -- Grand Palace of Hu'Xzoi #1
homepoints[89]  = { 3, 26,    -426,      0,     368, 224,  35, 3000}; -- The Garden of Ru'Hmet #1
homepoints[90]  = { 3, 27,       -540.844,      -4.000,       70.809,   74,  61, 3000}; -- Mount Zhayolm #1  // No valid location
homepoints[91]  = { 3, 28,    -303,     -8,     526,   0, 113, 2000}; -- Cape Terrigan #1
homepoints[92]  = { 3, 29,      88,    -15,    -217,   0, 153, 2000}; -- The Boyahda Tree #1
homepoints[93]  = { 3, 30,     182,     34,     -62, 223, 160, 3000}; -- Den of Rancor #2
homepoints[94]  = { 3, 31,     102,      0,     269, 191, 204, 3000}; -- Fei'Yin #2
homepoints[95]  = { 3, 32,     -63,     50,      81, 192, 205, 2000}; -- Ifrit's Cauldron #1
homepoints[96]  = { 4,  1,     573,      9,    -500,   0, 208, 2000}; -- Quicksand Caves #2
...
homepoints[111] = { 4, 16,     223,    -13,    -254,   0, 137, 2000}; -- Xarcabard [S] #1
homepoints[112] = { 4, 17,       5.539,      -0.434,       8.133,   73, 281, 2000}; -- Leafallia #1  // on your right when you enter.
homepoints[113] = { 4, 18,       66,      -70,       -554,   128, 155, 2000}; -- *Castle Zvahl Keep [S] #1  // same location as in the present
homepoints[114] = { 4, 19,       -65,     -17.5, 563,   224, 25, 2000}; -- Misareaux Coast #1
homepoints[115] = { 4, 20,       -212,     -21,  93,    64, 126, 1500}; -- Qufim Island #1
