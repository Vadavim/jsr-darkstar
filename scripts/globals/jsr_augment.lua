...
AUGMENT_NINJATOOL_EXPERTISE = 215;
...
local augStatsNeg = {AUGMENT_STAT_STRNEG, AUGMENT_STAT_VITNEG, AUGMENT_STAT_CHRNEG, AUGMENT_STAT_AGINEG, AUGMENT_STAT_DEXNEG, AUGMENT_STAT_MNDNEG, AUGMENT_STAT_INTNEG};
...
local petAugments = {
    ...
    {AUGMENT_PET_REGEN,         {2, 3},     20, 5, true, 0.1},
    {AUGMENT_PET_STORETP,       {2, 5},     30, 5, false, 0.00},
    {AUGMENT_PET_UDMG,          {1, 2},     50, 5, false, 0.00},
    {AUGMENT_PET_SUBTLEBLOW,    {5, 10},    1, 15, false, 0.00},
    {AUGMENT_PET_TPBONUS,       {1, 3},     50, 8, false, 0.00},
    {AUGMENT_PET_HASTE,         {0, 1},     70, 5, false, 0.00},
    {augPetStat,                {2, 4},     1, 40, true, 0.05},
};
...
local negativeAugments = {
    ...
    {AUGMENT_SLOW,              {0, 1},     1, 4, false, 0.02},
...
local jewelryAugments = {
    ...
    {AUGMENT_ENMITY,            {0, 1},     1, 5, false, 0.0},
    {AUGMENT_ENMITYNEG,         {0, 1},     1, 5, false, 0.0},
    {AUGMENT_MAGCRIT,           {0, 1},     55, 5, false, 0.0},
    {AUGMENT_MACC,              {0, 1},     30, 10, false, 0.0},
    {AUGMENT_MAGICBURST_DMG,    {3, 6},    15, 5, false, 0.0},
    {AUGMENT_SPELLINTERRUPT,    {4, 7},   1,  1, false, 0.0},
    ...
    {AUGMENT_STORESUBTLE,       {0, 0},     65, 5, false, 0.0},
    {AUGMENT_NINJATOOL_EXPERTISE,{3, 5},    1, 3, false, 0.0},
    {AUGMENT_RECYCLE,           {2, 4},     1, 3, false, 0.0},
    {AUGMENT_CUREPOTENCY,       {0, 2},     35, 5, false, 0.0},
    {AUGMENT_CURERCVD,          {2, 4},     30, 8, false, 0.0},
    {AUGMENT_DBLATK,            {0, 0},     70, 3, false, 0.0},
    {AUGMENT_FASTCAST,          {0, 1},     65, 3, false, 0.0},
    {AUGMENT_ZANSHIN,           {0, 2},     35, 5, false, 0.0},
    {AUGMENT_SUBTLEBLOW,        {1, 3},     1,  3, false, 0.0},
    {AUGMENT_WALTZPOTENCY,      {1, 3},     35, 3, false, 0.0},
    {AUGMENT_MATK,              {0, 0},     40, 5, false, 0.0},
    {AUGMENT_MDEF,              {0, 1},     40, 5, false, 0.0},
    {AUGMENT_MEVA,              {0, 2},     50, 5, false, 0.0},
    {AUGMENT_WSKILL_ACC,        {2, 6},    1, 3, false, 0.0},
    {AUGMENT_WSKILL_DAM,        {1, 3},     60, 3, false, 0.0},
    {AUGMENT_SHIELDMASTERY,     {2, 4},   45, 3, false, 0.0},
    {AUGMENT_RAPIDSHOT,         {0, 1},     35, 2, false, 0.0},
    {AUGMENT_SNAPSHOT,          {0, 1},     35, 2, false, 0.0},
    {AUGMENT_REGEN,             {0, 0},     25, 5, true, 0.04},
    {onePosStats,               {3, 5},     20, 4, true, 0.075},
    {augStats,                  {0, 0},     1, 25, true, 0.03},
    {statCombos,                {0, 1},     30, 5, true, 0.04},
    {augMagicSkills,            {0, 0},     30, 5, false, 0.025},
    {augMeleeSkills,            {0, 0},     30, 5, false, 0.025},
    {augRangeSkills,            {0, 0},     30, 5, false, 0.025},
    {augEleAcc,                 {1, 4},     1, 5, false, 0.0},
    {augEleAtt,                 {0, 3},     1, 5, false, 0.0},
    {augRes,                    {4, 8},    1, 20, false, 0.0},
    {augStatus,                 {3, 7},     1, 20, false, 0.0},
}

local neckAugments = {
    {AUGMENT_ACCRNGACC,         {0, 1},     30, 4, false, 0.0},
    {AUGMENT_CRITRATE,          {0, 0},     1, 2, false, 0.0},
    {AUGMENT_CRITDAMAGE,        {3, 8},    1, 4, false, 0.0},
    {AUGMENT_MACCMATK,          {0, 2},     70, 1, false, 0.0},
    {AUGMENT_ATKRATK,           {1, 2},     1, 2, true, 0.05},
    {AUGMENT_KICKATTACKS,       {1, 2},     50, 1, false, 0.0},
    {AUGMENT_HP,                {2, 5},    1, 15, true, 0.2},
    {AUGMENT_DEF,               {0, 2},     1, 8, true, 0.08},
    {AUGMENT_HPMP,              {1, 2},     30, 5, true, 0.1},
    {AUGMENT_EVA,               {0, 2},     1, 10, false, 0.0},
    {AUGMENT_TPBONUS,            {0, 1},    60, 4, false, 0.0},
    {AUGMENT_COUNTER,           {0, 1},     50, 3, false, 0.0},
};



local bodyAugment = {
    {AUGMENT_ENMITY,            {0, 1},     20, 3, false, 0.0},
    {AUGMENT_ENMITYNEG,         {0, 1},     20, 3, false, 0.0},
    {AUGMENT_ATKRATK,           {0, 1},     1, 2, true, 0.05},
    {AUGMENT_SNAPSHOT,          {0, 1},     35, 5, false, 0.0},
    {AUGMENT_RAPID_SHOT,         {0, 1},    35, 5, false, 0.0},
...
local legAugment = {
    ...
    {AUGMENT_DEF,               {0, 1},     1, 15, true, 0.8},
    {AUGMENT_HPMP,              {2, 3},     30, 4, true, 0.08},
    {AUGMENT_EVA,               {0, 1},     1, 5, false, 0.0},
    {AUGMENT_MATK,              {0, 1},     45, 8, false, 0.0},
    {AUGMENT_MACCMATK,          {0, 0},     70, 8, false, 0.0},
    {AUGMENT_UDMGPHYS,          {0, 1},     1, 3, false, 0.0},
    {AUGMENT_MAGCRIT,           {0, 1},     50, 4, false, 0.0},
    ...
    {AUGMENT_STORETP,           {0, 2},     65, 5, false, 0.0},
    {AUGMENT_STAT_AGI,          {0, 0},     1, 3, true, 0.03},
    {AUGMENT_STAT_VIT,          {0, 0},     1, 8, true, 0.03},
    {augRes,                    {4, 10},    1, 10, false, 0.0},
    {augStatus,                 {3, 7},     1, 10, false, 0.0},
};
...
local feetAugment = {
    ...
    {AUGMENT_REGEN,             {0, 0},     25, 5, true, 0.04},
    {AUGMENT_MEVA,              {0, 3},     20, 5, false, 0.0},
    {AUGMENT_STORETP,           {0, 2},     65, 5, false, 0.0},
    {AUGMENT_KICKATTACKS,       {1, 3},     45, 3, false, 0.0},
    {AUGMENT_WALTZ_TPCOST,      {15, 20},   55, 3, false, 0.0},
    {AUGMENT_WALTZPOTENCY,      {2, 4},     30, 3, false, 0.0},
    {AUGMENT_STAT_AGI,          {0, 0},     1, 5, true, 0.03},
    {augRes,                    {4, 10},    1, 10, false, 0.0},
    {augStatus,                 {3, 6},     1, 10, false, 0.0},
};

local handAugment = {
    {AUGMENT_HP,                {1, 3},    1, 10, true, 0.2},
    {AUGMENT_MP,                {1, 3},     1, 10, true, 0.10},
    {AUGMENT_ATKRATK,           {0, 1},     35, 8, true, 0.05},
    {AUGMENT_CRITRATE,          {0, 0},     1, 2, false, 0.0},
    {AUGMENT_CRITDAMAGE,        {3, 5},    1, 2, false, 0.0},
    {AUGMENT_DBLATK,           {0, 0},      35, 2, false, 0.0},
    {AUGMENT_TRPLATTACK,       {0, 0},      60, 2, false, 0.0},
    {AUGMENT_HPMP,              {2, 3},     30, 5, true, 0.07},
    {AUGMENT_ACCRNGACC,         {0, 1},     30, 6, false, 0.0},
    {AUGMENT_MAGCRIT,           {0, 2},     20, 4, false, 0.0},
    {AUGMENT_SKILLCHAIN_DAM,    {3, 6},     1, 2, false, 0.0},
    {AUGMENT_MAGICBURST_DMG,    {3, 6},     1, 2, false, 0.0},
    {AUGMENT_MACCMATK,          {0, 0},     70, 2, false, 0.0},
    {AUGMENT_SUBTLEBLOW,        {2, 4},     1, 8, false, 0.0},
    {AUGMENT_TPBONUS,           {0, 1},     60, 8, false, 0.0},
    {AUGMENT_STORETP,           {0, 2},     1, 5, false, 0.0},
    {AUGMENT_RAPIDSHOT,         {0, 1},     35, 5, false, 0.0},
    {AUGMENT_SNAPSHOT,          {0, 1},     35, 5, false, 0.0},
    {AUGMENT_STAT_STR,          {0, 0},     1, 8, true, 0.03},
    {AUGMENT_STAT_DEX,          {0, 0},     1, 8, true, 0.03},
    {AUGMENT_STAT_STR_DEX,      {0, 0},     50, 5, true, 0.02},
    {augRes,                    {4, 10},    1, 10, false, 0.0},
    {augStatus,                 {3, 7},     1, 10, false, 0.0},
    {augMeleeSkills,            {0, 1},     1, 4, false, 0.035},
    {augRangeSkills,            {0, 1},     1, 4, false, 0.035},
};
...
local headAugment = {
    ...
    {AUGMENT_MAGCRIT,           {0, 1},     50, 4, false, 0.0},
    {AUGMENT_ACCRNGACC,         {0, 1},     30, 3, false, 0.0},
    {AUGMENT_MACC,              {0, 1},     30, 4, false, 0.0},
    {AUGMENT_MDEF,              {0, 1},     1, 4, false, 0.0},
    {AUGMENT_MACCMATK,          {0, 0},     70, 2, false, 0.0},
    {AUGMENT_CONSERVEMP,        {1, 3},     30, 3, false, 0.0},
    {AUGMENT_CONSERVETP,        {1, 3},     30, 3, false, 0.0},
    {AUGMENT_RAPIDSHOT,         {0, 1},     35, 4, false, 0.0},
    {AUGMENT_SKILLCHAIN_DAM,    {4, 7},     1, 2, false, 0.0},
    {AUGMENT_MAGICBURST_DMG,    {4, 7},     1, 2, false, 0.0},
    {AUGMENT_SNAPSHOT,          {0, 1},     35, 5, false, 0.0},
    {AUGMENT_STAT_INT,          {0, 0},     1, 8, true, 0.03},
    {AUGMENT_STAT_MND,          {0, 0},     1, 8, true, 0.03},
    {AUGMENT_STAT_CHR,          {0, 0},     1, 8, true, 0.03},
    {AUGMENT_STAT_INT_MND_CHR,  {0, 1},     60, 5, true, 0.02},
    {augRes,                    {4, 10},    1, 10, false, 0.0},
    {augStatus,                 {3, 7},     1, 10, false, 0.0},
    {augMagicSkills,            {0, 1},     1, 4, false, 0.035},
    {augRangeSkills,            {0, 1},     1, 4, false, 0.035},
};
...
local backAugment = {
    ...
    {AUGMENT_MAGCRIT,           {0, 1},     50, 4, false, 0.0},
    {AUGMENT_MDEF,              {0, 1},     1, 4, false, 0.0},
    {AUGMENT_DEF,               {0, 1},     1, 6, true, 0.05},
    {AUGMENT_EVA,               {0, 1},     1, 3, false, 0.0},
    {AUGMENT_MEVA,              {0, 2},     1, 4, false, 0.0},
    {AUGMENT_CUREPOTENCY,       {0, 2},     50, 4, false, 0.0},
    {AUGMENT_CURERCVD,          {2, 4},     1, 4, false, 0.0},
    {AUGMENT_REGEN,             {0, 0},     45, 3, true, 0.03},
    {AUGMENT_STAT_INT,          {0, 0},     1, 8, true, 0.03},
    {AUGMENT_STAT_MND,          {0, 0},     1, 8, true, 0.03},
    {AUGMENT_STAT_CHR,          {0, 0},     1, 8, true, 0.03},
    {AUGMENT_STAT_INT_MND_CHR,  {0, 2},     60, 3, true, 0.02},
    {augRes,                    {4, 10},    1, 10, false, 0.0},
    {augStatus,                 {3, 6},     1, 10, false, 0.0},
...
local waistAugment = {
    ...
    {AUGMENT_CURERCVD,          {2, 4},     1, 4, false, 0.0},
    {AUGMENT_REGEN,             {0, 0},     45, 3, true, 0.03},
    {AUGMENT_STORETP,           {0, 1},     1, 4, false, 0.0},
    {AUGMENT_STAT_VIT,          {0, 1},     1, 5, true, 0.03},
    {AUGMENT_STAT_STR_VIT,      {0, 0},     40, 3, true, 0.02},
    {augRes,                    {4, 10},    1, 10, false, 0.0},
    {augStatus,                 {4, 6},     1, 10, false, 0.0},
    {augMeleeSkills,            {0, 1},     1, 3, false, 0.03},
};
...
local swordAugments = {
    ...
    {AUGMENT_DBLATKCRIT,        {0, 0},     70, 2, false, 0.0},
    {AUGMENT_STORESUBTLE,       {0, 2},     70, 3, false, 0.0},
    {AUGMENT_STAT_STR_VIT,      {0, 1},     1, 5, true, 0.03},
    ...
    {AUGMENT_SKILL_SWORD,       {0, 1},     1, 5, false, 0.035},
    {AUGMENT_SKILL_SHIELD,      {2, 5},     20, 5, false, 0.05},
...
local staffAugments = {
    ...
    {AUGMENT_HPMP,              {3, 5},     1, 3, true, 0.1},
    {AUGMENT_STAT_INT_MND_CHR,  {0, 1},     1, 5, true, 0.03},
    {AUGMENT_REGEN,             {0, 2},     35, 3, true, 0.1},
    ...
    {AUGMENT_SKILL_STAFF,       {3, 6},     1, 8, false, 0.05},
    {AUGMENT_SKILL_ELEMENTAL,   {1, 3},     50, 3, false, 0.035},
    {AUGMENT_SKILL_ENFEEBLE,    {1, 3},     50, 3, false, 0.035},
    {augWeaponskillStaff,  {1, 3},     1, 4, false, 0.0},
};

local clubAugment = {
    {AUGMENT_DEF,               {0, 2},     1, 5, true, 0.15},
    {AUGMENT_MP,                {3, 5},     1, 3, true, 0.2},
    {AUGMENT_STAT_STR_MND,      {0, 1},     1, 5, true, 0.04},
    {AUGMENT_CUREPOTENCY,       {3, 5},     1, 2, false, 0},
    {AUGMENT_MACCMATK,          {3, 5},     70, 2, false, 0.00},
    {AUGMENT_LIGHTATT,          {6, 15},    1, 3, false, 0.00},
    {AUGMENT_FASTCAST,          {2, 4},     70, 2, false, 0.00},
    {AUGMENT_SKILL_CLUB,        {0, 1},     1, 8, false, 0.035},
    {AUGMENT_SKILL_SHIELD,      {2, 5},     20, 5, false, 0.05},
    {AUGMENT_SKILL_DIVINE,      {5, 10},     1, 3, false, 0.05},
...
local daggerAugment = {
    ...
    {AUGMENT_STAT_DEX_AGI,      {0, 1},     1, 5, true, 0.02},
    {AUGMENT_EVA,               {0, 1},     1, 3, false, 0.0},
    {AUGMENT_QUADATK,           {0, 0},     70, 2, false, 0.0},
    {AUGMENT_CONSERVEMP,        {4, 10},     30, 5, false, 0.0},
    {AUGMENT_ZANSHIN,           {1, 4},     30, 2, false, 0.0},
    {AUGMENT_MAGCRIT,           {3, 6},     40, 8, false, 0.10},
    {AUGMENT_WINDATT,          {4, 9},    30, 3, false, 0.00},
    {AUGMENT_MACCMATK,          {5, 10},    55, 2, false, 0.00},
    {AUGMENT_SKILL_DAGGER,      {0, 1},     1, 4, false, 0.035},
...
local greatkatanaAugment = {
    ...
    {AUGMENT_EVA,               {2, 8},     1, 3, false, 0.0},
    {AUGMENT_MEVA,              {4, 8},     1, 2, false, 0.0},
    {AUGMENT_DBLATK,            {0, 1},     70, 5, false, 0.0},
    {AUGMENT_SKILL_GREATKATANA,     {0, 1},     1, 4, false, 0.035},
...
local h2hAugment = {
    {AUGMENT_STAT_STR_AGI,      {0, 1},     1, 5, true, 0.03},
    {AUGMENT_DBLATKCRIT,        {0, 0},     70, 3, false, 0.0},
    {AUGMENT_EVA,               {3, 6},     1, 3, false, 0.0},
...
local katanaAugment = {
    ...
    {AUGMENT_SKILL_KATANA,      {0, 1},     1, 4, false, 0.03},
    {AUGMENT_SKILL_NINJITSU,    {4, 10},     30, 4, false, 0.05},
...
local bowAugment = {
    ...
    {AUGMENT_CONSERVETP,        {1, 3},     1, 5, false, 0.0},
    {AUGMENT_SKILL_ARCHERY,     {0, 2},     1, 4, false, 0.03},
};
...
local markAugment = {
    ...
    {AUGMENT_CONSERVETP,        {1, 3},     1, 5, false, 0.0},
    {AUGMENT_SKILL_MARKSMANSHIP,     {0, 1},     1, 4, true, 0.03},
};

local throwingAugment = {
    {AUGMENT_STORETP,           {0, 2},     1, 3, false, 0.0},
    {AUGMENT_STAT_DEX_AGI,      {0, 1},     1, 3, true, 0.03},
    {AUGMENT_RACC,              {8, 15},     1, 8, false, 0.0},
    {AUGMENT_HP,                {3, 5},     1, 4, true, 0.15},
    {AUGMENT_RATK,               {2, 4},    1, 8, true, 0.2},
    {AUGMENT_RAPIDSHOT,          {3, 6},    1, 5, false, 0.15},
    {AUGMENT_SNAPSHOT,           {3, 6},    1, 5, false, 0.10},
    {AUGMENT_CONSERVETP,        {0, 3},     1, 5, false, 0.0},
    {AUGMENT_SKILL_THROWING,     {3, 5},     1, 4, true, 0.05},
};

local animatorAugment = {
    {AUGMENT_STORETP,           {1, 3},     1, 3, false, 0.0},
    {AUGMENT_STAT_DEX_AGI,      {0, 2},     1, 3, true, 0.03},
    {AUGMENT_HP,                {3, 5},     1, 4, true, 0.15},
    {AUGMENT_EVA,               {0, 2},     1, 4, false, 0.15},
    {AUGMENT_DBLATKCRIT,        {0, 1},     70, 2, false, 0.15},
    {AUGMENT_HASTE,             {0, 1},     70, 2, false, 0.15},
    {AUGMENT_SKILL_AME,         {1, 3},     1, 4, true, 0.05},
    {AUGMENT_SKILL_ARA,         {1, 3},     1, 4, true, 0.05},
    {AUGMENT_SKILL_AMA,         {1, 3},     1, 4, true, 0.05},
    {augRes,                    {4, 20},    1, 4, false, 0.0},
    {augStatus,                 {5, 8},     1, 4, false, 0.0},
};

local instrumentAugment = {
    {AUGMENT_STORETP,           {1, 4},     1, 3, false, 0.0},
    {AUGMENT_CONSERVETP,        {4, 7},     1, 3, false, 0.0},
    {AUGMENT_STAT_STR_CHR,      {0, 1},     1, 3, true, 0.03},
    {AUGMENT_STAT_STR_DEX,      {0, 1},     1, 3, true, 0.03},
    {AUGMENT_HP,                {3, 5},     1, 4, true, 0.15},
    {AUGMENT_MEVA,              {3, 5},     1, 4, false, 0.15},
...
local shieldAugment = {
    {AUGMENT_STORETP,           {0, 2},     1, 2, false, 0.0},
    {AUGMENT_CONSERVETP,        {2, 4},     1, 2, false, 0.0},
    {AUGMENT_CONSERVEMP,        {2, 4},     1, 2, false, 0.0},
    {AUGMENT_STAT_STR_VIT,      {0, 1},     1, 3, true, 0.03},
    {AUGMENT_HPMP,              {2, 4},     1, 4, true, 0.15},
    {AUGMENT_MEVA,              {2, 4},     40, 4, false, 0.15},
    {AUGMENT_STATUSRES,         {3, 5},     1, 4, false, 0.15},
    {AUGMENT_ZANSHIN,           {2, 5},     1, 2, false, 0.15},
    {AUGMENT_MDEF,              {3, 5},     1, 4, false, 0.15},
    {AUGMENT_SKILL_SHIELD,      {2, 3},     1, 4, true, 0.05},
    {AUGMENT_SHIELDMASTERY,     {4, 7},     1, 3, false, 0.0},
    {AUGMENT_DEF,               {0, 1},     1, 4, true, 0.10},
    {AUGMENT_ALLRES,            {3, 5},     60, 2, false, 0.0},
    {AUGMENT_ALLDARK,           {4, 8},    45, 2, false, 0.0},
    {AUGMENT_ALLLIGHT,          {4, 8},    45, 2, false, 0.0},
    {augRes,                    {4, 20},    1, 4, false, 0.0},
    {augStatus,                 {5, 8},     1, 4, false, 0.0},
};

local generalWeaponAugment = {
    {AUGMENT_STORETP,           {1, 3},     1, 3, false, 0.0},
    {AUGMENT_CONSERVETP,        {4, 8},     1, 5, false, 0.0},
    {AUGMENT_ACC,               {0, 2},     1, 3, false, 0.0},
    {AUGMENT_SUBTLEBLOW,        {3, 5},     1, 3, false, 0.0},
    {AUGMENT_HASTE,             {0, 1},     55, 3, false, 0.0},
    {AUGMENT_ATK,               {0, 2},     1, 8, true, 0.10},
...
local function getAugmentValue(augs, itemlvl)
    ...
    for  num,aug in pairs(augs) do
        ...
        table.insert(finalAugs, {augment, math.random(math.floor(min), math.floor(max))});
    end
    return finalAugs;
end
...
function pickAugments(item)
    ...
    elseif  (slot == SLOT_SUB and not item:isType(ITEM_WEAPON))          then augmentTable = join({shieldAugment});
    else
        ...
        elseif  (skillType == SKILL_SYH)                            then augmentTable = join({scytheAugment});
