...
function onPetAbility(target, pet, skill, master)
    ...
    local duration = utils.clamp(3 + (chr + summoning) / 10, 3, 6) + tp / 1000;

    local effects = {EFFECT_STR_DOWN, EFFECT_DEX_DOWN, EFFECT_INT_DOWN,
        EFFECT_VIT_DOWN, EFFECT_AGI_DOWN, EFFECT_MND_DOWN, EFFECT_CHR_DOWN};
