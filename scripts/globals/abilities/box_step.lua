        ...
        if (mjob == 19) then
            if (target:hasStatusEffect(EFFECT_SLUGGISH_DAZE_1)) then
                ...
                if (player:hasStatusEffect(EFFECT_PRESTO)) then
                    target:addStatusEffect(EFFECT_SLUGGISH_DAZE_3,1,0,90);
                    daze = 3;
                    effect = 3;
                else
                    target:addStatusEffect(EFFECT_SLUGGISH_DAZE_2,1,0,90);
                    daze = 2;
                    effect = 2;
                end
            ...
            elseif (target:hasStatusEffect(EFFECT_SLUGGISH_DAZE_2)) then
                ...
                if (player:hasStatusEffect(EFFECT_PRESTO)) then
                    target:addStatusEffect(EFFECT_SLUGGISH_DAZE_4,1,0,90);
                    daze = 3;
                    effect = 4;
                else
                    target:addStatusEffect(EFFECT_SLUGGISH_DAZE_3,1,0,90);
            ...
            elseif (target:hasStatusEffect(EFFECT_SLUGGISH_DAZE_3)) then
                ...
                if (player:hasStatusEffect(EFFECT_PRESTO)) then
                    target:addStatusEffect(EFFECT_SLUGGISH_DAZE_5,1,0,90);
                    daze = 3;
                    effect = 5;
                else
                    target:addStatusEffect(EFFECT_SLUGGISH_DAZE_4,1,0,90);
            ...
            elseif (target:hasStatusEffect(EFFECT_SLUGGISH_DAZE_5)) then
                ...
                if (player:hasStatusEffect(EFFECT_PRESTO)) then
                    ...
                    target:addStatusEffect(EFFECT_SLUGGISH_DAZE_1,1,0,90);
                    daze = 2;
                    effect = 1;
                end
            end;
