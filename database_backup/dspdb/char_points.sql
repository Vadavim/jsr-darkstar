...
CREATE TABLE IF NOT EXISTS `char_points` (
  ...
  `guild_fishing` int(32) unsigned NOT NULL DEFAULT '0',
  `guild_woodworking` int(32) unsigned NOT NULL DEFAULT '0',
  `guild_smithing` int(32) unsigned NOT NULL DEFAULT '0',
